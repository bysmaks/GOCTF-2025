# Инструкция для запуска бота в WSL:
# 1. Установите Python и pip в WSL (если не установлены):
#    sudo apt update && sudo apt install python3 python3-pip
# 2. Установите pyTelegramBotAPI:
#    pip3 install pyTelegramBotAPI
# 3. Соберите бинарники:
#    go build -o checker_go checker_go.go
#    # Для checker_cpp.cpp требуется линковка с OpenSSL:
#    sudo apt install libssl-dev
#    g++ checker_cpp.cpp -o checker_cpp -lssl -lcrypto && upx -o checker_cpp_upx checker_cpp
# 4. Убедитесь, что файлы api.txt, part1.txt, part2.txt, flag.txt, encrypted_script.b64 находятся в одной папке с bot.py.
# 5. Запустите бота:
#    python3 bot.py
